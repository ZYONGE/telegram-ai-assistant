...
class PromptBuilder:
    ...
    def _read_profile(self) -> str:
        if not self._profile_path.exists():
            return ""
        return clean_profile(self._profile_path.read_text(encoding="utf-8"))
